...
class MakeCartCommand extends Command
{
    use ComponentParser;
    /**
    ...
    {
        return app_path("Livewire/Cart/{$component}.php");
    }
    ...
    protected function displayComponentInfo($className)
    {
        ...
        $classPath = "App/Livewire/Cart/{$className}";
        // $viewPath = "resources/views/livewire/cart/{$slug}.blade.php";
